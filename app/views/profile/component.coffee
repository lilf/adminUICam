...
class TableView extends Backbone.View
  ...
  setOption: (option) ->
    ...
    if _.isArray(x) and _.isArray(y) and _.isString(z)
      ...
      # @table = new ers.Table option.th, option.td
      # @table = @getTableOption option
      ...
      @table = @$el.DataTable dataTableOption
...
exports.table = ($el, option) ->
  ...
  # console.log $el
  # console.log ($el)[0]
  # console.log ($el)[0].firstChild.className
  # console.log ($el)[0].className
  # liClassName = ($el)[0].className
  # tableClassName = ($el)[0].firstChild.className
  # tableComponent = ($el)[0].firstChild
  # console.log tableComponent

  tableView.setOption option
  # tableView.getTableOption tableComponent
  # console.log $('.liClassName .tableClassName')
  # console.log $el
  # tableComponent = ($el)[0].firstChild
  # console.log tableComponent.className
  # console.log $(tableComponent).html()

  # console.log $el.html()
  # console.log option
  # console.log option.data
  # console.log  $('.liClassName .tableClassName').html
  # console.log  $('.liClassName table').html
